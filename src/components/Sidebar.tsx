...
import { LayoutDashboard, ShoppingBag, Utensils, Settings, LogOut, MonitorPlay, Building2, Smartphone, Users, ChevronDown, Search, Check, Dumbbell, DoorOpen, Sliders, MapPin } from 'lucide-react';
...
const Sidebar = () => {
  ...
  const allMenuItems = [
    ...
    { icon: MapPin, label: 'POIs', path: '/pois' },
